...
<header class="bg-onyx text-persian-orange">
  <nav class="flex items-center justify-between p-6 mx-auto max-w-7xl lg:px-8" aria-label="Global">
    ...
    <div class="{mobileMenuOpen ? 'hidden': 'flex'} lg:hidden">
      <button on:click={() => mobileMenuOpen = !mobileMenuOpen} type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
  ...
  <div class="{!mobileMenuOpen && 'hidden'} lg:hidden" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-y-0 right-0 z-10 w-full px-6 py-6 overflow-y-auto bg-white sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
      <div class="flex items-center justify-between">
        ...
        <button on:click={() => mobileMenuOpen = !mobileMenuOpen} type="button" class="-m-2.5 rounded-md p-2.5 text-gray-700">
      ...
      <div class="flow-root mt-6">
        <div class="-my-6 divide-y divide-gray-500/10">
          <div class="py-6 space-y-2">
            <a href="/card-finder" class="block px-3 py-2 -mx-3 text-base font-semibold leading-7 text-gray-900 rounded-lg hover:bg-gray-50">Card Finder</a>
